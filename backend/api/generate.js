...
🛠️ דגשים וכלים למפקד:
דגש למעקב: הנחיה ישירה למפק"צ על מה עליו לשים לב בהמשך העבודה מול הצוער (למשל, שים לב לאופן שבו הוא מגיב תחת עומס משימות, וודא שהוא לא זונח את הטיפול בפרט).
כלי פרקטי ליישום: טכניקה או משימה ממוקדת שהמפקד יכול לתת לצוער כדי לתרגל את הפער (למשל, בהתנסויות הבאות, תן לו משימה שדורשת חלוקת קשב ברורה בין עמידה בזמנים לווידוא זמני מנוחה לחיילים, כדי לתרגל את האיזון).
    `
},
