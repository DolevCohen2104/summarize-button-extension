export default async function handler(req, res) {
  ...
  try {
    ...
    אתה יועץ מקצועי למפקדי צוותים בקורס קצינים. תפקידך לנתח נתונים מסוכמים מתוך "סימולטור פיקודי" ולהפיק סיכום טקסטואלי פרקטי, מדויק ונקי, שישמש את מפקד הצוות (המפק"צ) לחוו"ד אמצע עם הצוער.
